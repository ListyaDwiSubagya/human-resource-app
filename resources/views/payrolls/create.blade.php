            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('payrolls.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <labbel for="" class="form-label">Deductions</labbel>
                        ...
                        <div class="mb-3">
                            <labbel for="" class="form-label">Bonuses</labbel>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control datetime" name="pay_date" required>
                            @error('pay_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
